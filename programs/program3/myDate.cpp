...
int myDate::randomBd(){
	...
	//srand(time(NULL));
	int jd1 = Greg2Julian(d1.year,d1.month, d1.day);
	int jd2 = Greg2Julian(d2.year,d2.month,d2.day);
	int randomDate = (rand()%(jd2-jd1+1)+jd1);
	Julian2Greg(randomDate, year, month, day);
	return randomDate;
